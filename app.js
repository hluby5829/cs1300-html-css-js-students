...
const updatePage = async () => {
  ...
  const filteredFruits = fruitsArray.filter(fruit => fruit.nutritions.sugar < 10);
  ...
  const existingElm = document.getElementById('cs1300-gallery');
  existingElm.append(newElm);
